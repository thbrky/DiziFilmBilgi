...
const Header = ({ isLoggedIn }) => {
  return (
    ...
    >
      ...
      {/* Giriş Yap ve Kayıt Ol Butonları (isLoggedIn durumuna göre gösterilir) */}
      <Box flex="1" display="flex" justifyContent="flex-end" mr={"2rem"}>
        ...
        {/* isLoggedIn true olduğunda giriş yap ve kayıt ol butonlarını gösterme */}
        {isLoggedIn && (
          <>
            <Button as={Link} to="/" fontSize="xl" mr="2rem" color="#ECC94B">
              Ana Sayfa
            </Button>
          </>
        )}
